        ...
        <div class="landing-footer-container">
            <div class="flex flex-wrap z-10">
                <div class="w-6/12 lg:w-3/12 flex">
                    <ul class="list-none p-0 m-0">
                        ...
                        <li class="mb-6">
                            <a href="https://github.com/khulnasoft/web-packages-examples" class="text-surface-500 dark:text-surface-400 font-medium hover:text-primary rounded transition-all duration-300" target="_blank" rel="noopener noreferrer"
                                >Examples</a
                            >
                        </li>
                    </ul>
                ...
                <div class="w-6/12 lg:w-3/12 flex">
                    <ul class="list-none p-0 m-0">
                        ...
                        <li class="mb-6">
                            <a href="https://github.com/orgs/khulnasoft/discussions" class="text-surface-500 dark:text-surface-400 font-medium hover:text-primary rounded transition-all duration-300" target="_blank" rel="noopener noreferrer">Forum</a>
                        </li>
                        <li class="mb-6">
                ...
                <div class="w-6/12 lg:w-3/12 flex">
                    <ul class="list-none p-0 m-0">
                        ...
                        <li class="mb-6">
                            <a href="https://www.khulnasoft.com/store/" class="text-surface-500 dark:text-surface-400 font-medium hover:text-primary rounded transition-all duration-300" target="_blank" rel="noopener noreferrer">Store</a>
                        </li>
                        <li class="mb-6">
                            <a href="https://github.com/khulnasoft/web-packages" class="text-surface-500 dark:text-surface-400 font-medium hover:text-primary rounded transition-all duration-300" target="_blank" rel="noopener noreferrer"
                                >Source Code</a
                            >
                        </li>
                        <li class="mb-6">
                            <a href="https://twitter.com/khulnasoft" class="text-surface-500 dark:text-surface-400 font-medium hover:text-primary rounded transition-all duration-300" target="_blank" rel="noopener noreferrer">Twitter</a>
                        </li>
                        <li class="mb-6">
                            <a href="https://www.khulnasoft.com/newsletter" class="text-surface-500 dark:text-surface-400 font-medium hover:text-primary rounded transition-all duration-300" target="_blank" rel="noopener noreferrer">Newsletter</a>
                        </li>
                        <li class="mb-6">
                            <a href="https://gear.khulnasoft.com/" class="text-surface-500 dark:text-surface-400 font-medium hover:text-primary rounded transition-all duration-300" target="_blank" rel="noopener noreferrer">PrimeGear</a>
                        </li>
                        <li class="mb-6">
            ...
            <div class="flex flex-wrap justify-between py-12 gap-8">
                ...
                <div class="flex items-center gap-2">
                    <a href="https://twitter.com/khulnasoft" class="linkbox linkbox-icon">
                        <i class="pi pi-twitter"></i>
                    </a>
                    <a href="https://github.com/khulnasoft/web-packages" class="linkbox linkbox-icon">
                        <i class="pi pi-github"></i>
                    </a>
                    <a href="https://discord.gg/gzKFYnpmCY" class="linkbox linkbox-icon">
                        <i class="pi pi-discord"></i>
                    </a>
                    <a href="https://github.com/orgs/khulnasoft/discussions" class="linkbox linkbox-icon">
