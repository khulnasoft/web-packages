        ...
        <div>
            ...
            <div class="card mb-8" style="border-radius: 50px">
                <div class="flex flex-col md:flex-row items-center gap-6 md:gap-20 mb-20">
                    <div class="w-full md:w-6/12">
                        <img alt="PrimeVue UI Kit" src="https://khulnasoft.com/cdn/khulnasoft/images/uikit/uikit-figma.png" class="w-full" />
                    </div>
                    <div class="w-full md:w-6/12">
                ...
                <div class="flex flex-col md:flex-row items-center gap-6 md:gap-20 mb-20">
                    ...
                    <div class="w-full md:w-6/12">
                        <img alt="PrimeVue Designer" src="https://khulnasoft.com/cdn/khulnasoft/images/uikit/uikit-system.png" class="w-full" />
                    </div>
                </div>
                <div class="flex flex-col md:flex-row items-center gap-6 md:gap-20 mb-20">
                    <div class="w-full md:w-6/12">
                        <img alt="PrimeVue Designer" src="https://khulnasoft.com/cdn/khulnasoft/images/uikit/uikit-themes.png" class="w-full" />
                    </div>
                    <div class="w-full md:w-6/12">
                ...
                <div class="flex flex-col md:flex-row items-center gap-6 md:gap-20">
                    ...
                    <div class="w-full md:w-6/12">
                        <img alt="Tokens Support" src="https://khulnasoft.com/cdn/khulnasoft/images/uikit/uikit-tokens.png" class="w-full" />
                    </div>
                </div>
            </div>
            ...
            <div class="flex flex-col md:flex-row gap-6 md:gap-6 mb-8">
                ...
                >
                    ...
                    <img alt="Figma Light" src="https://khulnasoft.com/cdn/khulnasoft/images/uikit/logo-figma-light.svg" class="w-16" />
                </a>
                <a
                ...
                >
                    ...
                    <img alt="Figma Dark" src="https://khulnasoft.com/cdn/khulnasoft/images/uikit/logo-figma-dark.svg" class="w-16" />
                </a>
            </div>
            ...
            <div class="card mb-8" style="border-radius: 50px">
                ...
                <div class="text-center mb-8">
                    <a href="https://www.khulnasoft.com/uikit/licenses" class="doc-link">View License Details</a>
                </div>
                    ...
                    <div class="col-span-12 lg:col-span-4">
                        <div class="p-4 h-full">
                            <div class="shadow p-8 h-full flex flex-col bg-surface-0 dark:bg-surface-900" style="border-radius: 6px">
                                ...
                                <a v-ripple href="https://www.khulnasoft.com/store/uikit.xhtml" class="bg-blue-500 text-white hover:bg-blue-400 p-4 w-full rounded text-center transition-colors duration-300 font-bold p-ripple">Buy Now</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-span-12 lg:col-span-4">
                        <div class="p-4 h-full">
                            <div class="shadow p-8 h-full flex flex-col bg-surface-0 dark:bg-surface-900" style="border-radius: 6px">
                                ...
                                <a v-ripple href="https://www.khulnasoft.com/store/uikit.xhtml" class="bg-purple-500 text-white hover:bg-purple-400 p-4 w-full rounded text-center transition-colors duration-300 font-bold p-ripple">Buy Now</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="grid grid-cols-12 gap-4 text-lg">
                    ...
                    <div class="col-span-12 lg:col-span-4 px-2 lg:px-8">
                        ...
                        <p class="mt-0 mb-12 p-0 leading-normal">
                            ...
                            <a href="https://github.com/orgs/khulnasoft/discussions/categories/figma-ui-kit" class="doc-link">Forum</a>.
                        </p>
                    </div>
                    <div class="col-span-12 lg:col-span-4 px-2 lg:px-8">
...
export default {
    ...
    computed: {
        coverImage() {
            ...
            return 'https://khulnasoft.com/cdn/khulnasoft/' + image;
        }
    }
};
</script>
