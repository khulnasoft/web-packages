<template>
    <DocSectionText v-bind="$attrs">
        ...
        <p>
            The most notable feature is the new <NuxtLink to="/theming/styled">styled mode</NuxtLink> implementation. Previous iterations use SASS at an external repo called <i>khulnasoft-sass-theme</i> which requires compilation of a
