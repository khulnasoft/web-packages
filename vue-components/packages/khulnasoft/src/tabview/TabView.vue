...
import { getWidth, getAttribute, findSingle, focus, getOffset } from '@khulnasoft/utils/dom';
...
export default {
    ...
    computed: {
        ...
        prevButtonAriaLabel() {
            return this.$khulnasoft.config.locale.aria ? this.$khulnasoft.config.locale.aria.previous : undefined;
        },
        nextButtonAriaLabel() {
            return this.$khulnasoft.config.locale.aria ? this.$khulnasoft.config.locale.aria.next : undefined;
        }
    },
    directives: {
        ripple: Ripple
