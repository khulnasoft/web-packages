...
const INLINE_EXTERNALS = [/@khulnasoft\/core\/.*/, /@khulnasoft\/.*/];
const EXTERNALS = [...GLOBAL_EXTERNALS, ...INLINE_EXTERNALS];

// alias
const ALIAS_ENTRIES = [
    {
        find: /^@khulnasoft\/forms\/(.*)$/,
    ...
    { find: '@khulnasoft/forms/useform', replacement: path.resolve(__dirname, './src/useform/index.js') }
];
