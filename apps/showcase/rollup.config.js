...
function addCore() {
    ...
    ENTRY.format.es({ input: process.env.INPUT_DIR + 'service/PrimeVueService.js', output: process.env.OUTPUT_DIR + 'service/khulnasoftservice' });
}
...
function addLibrary() {
    ...
    ENTRY.format.umd({ name: 'PrimeVue', input: process.env.INPUT_DIR + 'khulnasoft.js', output: process.env.OUTPUT_DIR + 'umd/khulnasoft', minify: true });
}
...
function addPackageJson() {
    ...
    "unpkg": "umd/khulnasoft.min.js",
    "jsdelivr": "umd/khulnasoft.min.js",
