<template>
    <DocSectionText v-bind="$attrs">
        <p>Here is the full list of PrimeIcons. More icons will be added periodically and you may also <a href="https://github.com/khulnasoft/primeicons/issues">request new icons</a> at the issue tracker.</p>
    </DocSectionText>
