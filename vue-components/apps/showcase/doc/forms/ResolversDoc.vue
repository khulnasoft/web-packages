<template>
    <DocSectionText v-bind="$attrs">
        <p>
            ...
            be imported from <i>@khulnasoft/forms/resolvers</i> path.
        </p>
    </DocSectionText>
...
<script>
import { superStructResolver } from '@khulnasoft/forms/resolvers/superstruct';
import { valibotResolver } from '@khulnasoft/forms/resolvers/valibot';
import { yupResolver } from '@khulnasoft/forms/resolvers/yup';
import { zodResolver } from '@khulnasoft/forms/resolvers/zod';
