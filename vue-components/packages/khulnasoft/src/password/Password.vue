...
<script>
import { absolutePosition, addStyle, getOuterWidth, isTouchDevice, relativePosition } from '@khulnasoft/utils/dom';
...
import EyeSlashIcon from '@khulnasoft/icons/eyeslash';
...
export default {
    ...
    computed: {
        ...
        weakText() {
            return this.weakLabel || this.$khulnasoft.config.locale.weak;
        },
        mediumText() {
            return this.mediumLabel || this.$khulnasoft.config.locale.medium;
        },
        strongText() {
            return this.strongLabel || this.$khulnasoft.config.locale.strong;
        },
        promptText() {
            return this.promptLabel || this.$khulnasoft.config.locale.passwordPrompt;
        },
        overlayUniqueId() {
