...
<script>
import { blockBodyScroll, isAttributeEquals, focus, addClass, unblockBodyScroll } from '@khulnasoft/utils/dom';
import { ZIndex } from '@khulnasoft/utils/zindex';
import EyeIcon from '@khulnasoft/icons/eye';
import RefreshIcon from '@khulnasoft/icons/refresh';
import SearchMinusIcon from '@khulnasoft/icons/searchminus';
import SearchPlusIcon from '@khulnasoft/icons/searchplus';
import TimesIcon from '@khulnasoft/icons/times';
import UndoIcon from '@khulnasoft/icons/undo';
...
export default {
    ...
    methods: {
        ...
        onBeforeEnter() {
            ZIndex.set('modal', this.mask, this.$khulnasoft.config.zIndex.modal);
        },
        onEnter() {
            this.focus();
            this.$emit('show');
    ...
    computed: {
        ...
        rightAriaLabel() {
            return this.$khulnasoft.config.locale.aria ? this.$khulnasoft.config.locale.aria.rotateRight : undefined;
        },
        leftAriaLabel() {
            return this.$khulnasoft.config.locale.aria ? this.$khulnasoft.config.locale.aria.rotateLeft : undefined;
        },
        zoomInAriaLabel() {
            return this.$khulnasoft.config.locale.aria ? this.$khulnasoft.config.locale.aria.zoomIn : undefined;
        },
        zoomOutAriaLabel() {
            return this.$khulnasoft.config.locale.aria ? this.$khulnasoft.config.locale.aria.zoomOut : undefined;
        },
        zoomImageAriaLabel() {
            return this.$khulnasoft.config.locale.aria ? this.$khulnasoft.config.locale.aria.zoomImage : undefined;
        },
        closeAriaLabel() {
            return this.$khulnasoft.config.locale.aria ? this.$khulnasoft.config.locale.aria.close : undefined;
        }
    },
    components: {
        Portal: Portal,
