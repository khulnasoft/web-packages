<template>
    <DocSectionText v-bind="$attrs">
        <h4>SASS Themes</h4>
        <p>
            The styled mode theming has been reimplemented from scratch based on an all-new architecture. The <i>theme.css</i> and the <i>khulnasoft/resources</i> do not exist anymore, so any imports of these assets needs to be removed. If you had a
        ...
        <ul class="flex flex-col gap-2 leading-normal">
            <li>Imports from <i class="mark">khulnasoft/api</i> have been relocated to <i class="mark">@khulnasoft/core/api</i>.</li>
        </ul>

        <h4>Removed Files</h4>
        <ul class="flex flex-col gap-2 leading-normal">
            <li>Themes under the <i class="mark">khulnasoft/resources</i> path, migration to new styled mode is necessary.</li>
            <li>The legacy Tailwind preset at <i class="mark">khulnasoft/passthrough/tailwind</i>, migrate to the <a href="https://tailwind.khulnasoft.com" target="_blank" rel="noopener noreferrer" class="doc-link">Tailwind Presets</a> project.</li>
        </ul>
        ...
        <p>
            The <a href="https://tailwind.khulnasoft.com" target="_blank" rel="noopener noreferrer" class="doc-link">Tailwind CSS</a> presets for the unstyled mode do not support v4 yet, an update is under development and scheduled for the end of
            July 2024.
        </p>
        ...
        <h4>Nuxt Module</h4>
        <p>
            The <a href="https://www.npmjs.com/package/nuxt-khulnasoft" target="_blank" rel="noopener noreferrer" class="doc-link">nuxt-khulnasoft</a> module has been replaced with the new
            <a href="https://www.npmjs.com/package/@khulnasoft/nuxt-module" target="_blank" rel="noopener noreferrer" class="doc-link">@khulnasoft/nuxt-module</a>. The old module is still maintained for v3 users.
        </p>
    </DocSectionText>
</template>
