...
const INLINE_EXTERNALS = [/@khulnasoft\/core\/.*/, /@khulnasoft\/icons\/.*/, '@khulnasoft/styled', /@khulnasoft\/utils\/.*/];
...
const ALIAS_ENTRIES = [
    ...
    // @todo - Remove
    { find: '@khulnasoft/core/api', replacement: path.resolve(__dirname, '../core/src/api/Api.js') },
    { find: '@khulnasoft/core/base/style', replacement: path.resolve(__dirname, '../core/src/base/style/BaseStyle.js') },
    { find: '@khulnasoft/core/base', replacement: path.resolve(__dirname, '../core/src/base/Base.js') },
    { find: '@khulnasoft/core/basecomponent/style', replacement: path.resolve(__dirname, '../core/src/basecomponent/style/BaseComponentStyle.js') },
    { find: '@khulnasoft/core/basecomponent', replacement: path.resolve(__dirname, '../core/src/basecomponent/BaseComponent.vue') },
    { find: '@khulnasoft/core/basedirective', replacement: path.resolve(__dirname, '../core/src/basedirective/BaseDirective.js') },
    { find: '@khulnasoft/core/baseeditableholder', replacement: path.resolve(__dirname, '../core/src/baseeditableholder/BaseEditableHolder.vue') },
    { find: '@khulnasoft/core/baseinput', replacement: path.resolve(__dirname, '../core/src/baseinput/BaseInput.vue') },
    { find: '@khulnasoft/core/config', replacement: path.resolve(__dirname, '../core/src/config/PrimeVue.js') },
    { find: '@khulnasoft/core/service', replacement: path.resolve(__dirname, '../core/src/service/PrimeVueService.js') },
    { find: '@khulnasoft/core/usestyle', replacement: path.resolve(__dirname, '../core/src/usestyle/UseStyle.js') },
    { find: '@khulnasoft/core/utils', replacement: path.resolve(__dirname, '../core/src/utils/Utils.js') },
    { find: '@khulnasoft/core', replacement: path.resolve(__dirname, '../core/src/index.js') },
    { find: '@khulnasoft/icons/baseicon/style', replacement: path.resolve(__dirname, '../icons/src/baseicon/style/BaseIconStyle.js') },
    { find: '@khulnasoft/icons/baseicon', replacement: path.resolve(__dirname, '../icons/src/baseicon/BaseIcon.vue') }
];
...
function addLibrary() {
    ...
    ENTRY.format.umd({ name: 'PrimeVue', input: process.env.INPUT_DIR + 'umd/khulnasoft.js', output: process.env.OUTPUT_DIR + 'umd/khulnasoft', minify: true });
}
