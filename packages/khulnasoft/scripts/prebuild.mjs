...
// API
export * from '@khulnasoft/core';

// BaseIcon
export { default as BaseIcon } from '@khulnasoft/icons/baseicon';
export { default as BaseIconStyle } from '@khulnasoft/icons/baseicon/style';

// Themes
export * from '@khulnasoft/styled';
...
// UseConfirm
export * from 'khulnasoft/useconfirm';

// UseDialog
export * from 'khulnasoft/usedialog';

// UseToast
export * from 'khulnasoft/usetoast';

// UseStyle
export * from 'khulnasoft/usestyle';
`
    ]
};
...
`
                    ...
                    modules.esm.push(
                        `
// ${fileName}
export * from 'khulnasoft/${folderName}';
export { default as ${fileName} } from 'khulnasoft/${folderName}';
`
                    );
                }
...
`
                                ...
                                modules.esm.push(
                                    `export * from 'khulnasoft/${folderName}/style';
export { default as ${subFileName} } from 'khulnasoft/${folderName}/style';
`
                                );
                            }
                        }
...
// UMD
fs.writeFileSync(INPUT_DIR + 'umd/khulnasoft.js', modules.umd.join(''));
