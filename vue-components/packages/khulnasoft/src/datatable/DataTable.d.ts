 ...
 *
 * [Live Demo](https://www.khulnasoft.com/datatable/)
 *
 * @module datatable
 *
 */
import type { DefineComponent, DesignToken, EmitFn, HintedString, Nullable, PassThrough } from '@khulnasoft/core';
import type { ComponentHooks } from '@khulnasoft/core/basecomponent';
import type { ButtonProps } from 'khulnasoft/button';
import type { ColumnPassThroughOptionType } from 'khulnasoft/column';
import type { ColumnGroupPassThroughOptionType } from 'khulnasoft/columngroup';
import type { PaginatorPassThroughOptionType } from 'khulnasoft/paginator';
import type { PassThroughOptions } from 'khulnasoft/passthrough';
import type { RowPassThroughOptionType } from 'khulnasoft/row';
import type { VirtualScrollerPassThroughOptionType, VirtualScrollerProps } from 'khulnasoft/virtualscroller';
