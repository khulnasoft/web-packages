    ...
    <div class="card dock-demo">
        ...
        <div class="dock-window dock-advanced">
            ...
            <Dialog v-model:visible="displayTerminal" header="Terminal" :breakpoints="{ '960px': '50vw' }" :style="{ width: '40vw' }" :maximizable="true">
                <Terminal welcomeMessage="Welcome to PrimeVue(cmd: 'date', 'greet {0}' and 'random')" prompt="khulnasoft $" />
            </Dialog>
...
import TerminalService from 'khulnasoft/terminalservice';
    ...
    data() {
        return {
            ...
            items: [
                {
                    label: 'Finder',
                    icon: 'https://khulnasoft.com/cdn/khulnasoft/images/dock/finder.svg',
                    command: () => {
                ...
                {
                    label: 'Terminal',
                    icon: 'https://khulnasoft.com/cdn/khulnasoft/images/dock/terminal.svg',
                    command: () => {
                ...
                {
                    label: 'App Store',
                    icon: 'https://khulnasoft.com/cdn/khulnasoft/images/dock/appstore.svg',
                    command: () => {
                ...
                {
                    label: 'Safari',
                    icon: 'https://khulnasoft.com/cdn/khulnasoft/images/dock/safari.svg',
                    command: () => {
                ...
                {
                    label: 'Photos',
                    icon: 'https://khulnasoft.com/cdn/khulnasoft/images/dock/photos.svg',
                    command: () => {
                ...
                {
                    label: 'GitHub',
                    icon: 'https://khulnasoft.com/cdn/khulnasoft/images/dock/github.svg'
                },
                {
                    label: 'Trash',
                    icon: 'https://khulnasoft.com/cdn/khulnasoft/images/dock/trash.png',
                    command: () => {
...
.dock-demo > .dock-window {
    ...
    height: 450px;
    position: relative;
    background-image: url("https://khulnasoft.com/cdn/khulnasoft/images/dock/window.jpg");
...
import { useToast } from 'khulnasoft/usetoast';
import TerminalService from 'khulnasoft/terminalservice';
import { NodeService } from '@/service/NodeService';
import { PhotoService } from '@/service/PhotoService';
