...
const core_dependencies = {
    ...
    vite: '^4.0.0',
    khulnasoft: pkg.version || PrimeVue.version || 'latest',
    '@khulnasoft/themes': pkg.version || PrimeVue.version || 'latest',
    '@khulnasoft/auto-import-resolver': pkg.version || PrimeVue.version || 'latest',
    '@khulnasoft/forms': pkg.version || PrimeVue.version || 'latest',
...
const getVueApp = (props = {}, sourceType) => {
    const path = 'src/';
    const { code: sources, title = 'khulnasoft_demo', description = '', service, extPages, dependencies: deps, component, extFiles } = props;
    ...
    if (deps !== null && component !== null) {
        imports += `import ${component} from 'khulnasoft/${component.toLowerCase()}';
`;
...
import {PrimeVueResolver} from '@khulnasoft/auto-import-resolver';
...
import ConfirmationService from 'khulnasoft/confirmationservice'
import DialogService from 'khulnasoft/dialogservice'
import ToastService from 'khulnasoft/toastservice';
...
<script>
import { $t, updatePreset, updateSurfacePalette } from '@khulnasoft/themes';
import Aura from '@khulnasoft/themes/aura';
import Lara from '@khulnasoft/themes/lara';
import Nora from '@khulnasoft/themes/nora';
...
export default {
    ...
    methods: {
        ...
        onRippleChange(value) {
            this.$khulnasoft.config.ripple = value;
        },
    ...
    computed: {
        rippleActive() {
            return this.$khulnasoft.config.ripple;
        }
    }
};
<\/script>
`
        ...
        [`${path}presets/Noir.js`]: {
            content: `import { definePreset } from '@khulnasoft/themes';
        import Aura from '@khulnasoft/themes/aura';
