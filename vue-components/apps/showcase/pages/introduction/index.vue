...
export default {
    ...
    computed: {
        introDesktopImg() {
            return `https://khulnasoft.com/cdn/khulnasoft/images/overview${this.$appState.darkTheme ? '-dark' : ''}.png`;
        },
        introMobileImg() {
            return `https://khulnasoft.com/cdn/khulnasoft/images/overview${this.$appState.darkTheme ? '-dark' : ''}-mobile.png`;
        }
    }
};
</script>
