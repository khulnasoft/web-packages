...
<script>
import { addClass, addStyle, blockBodyScroll, focus, getOuterHeight, getOuterWidth, getViewport, setAttribute, unblockBodyScroll } from '@khulnasoft/utils/dom';
...
import WindowMaximizeIcon from '@khulnasoft/icons/windowmaximize';
import WindowMinimizeIcon from '@khulnasoft/icons/windowminimize';
...
export default {
    ...
    methods: {
        ...
        onEnter() {
            ...
            if (this.autoZIndex) {
                ZIndex.set('modal', this.mask, this.baseZIndex + this.$khulnasoft.config.zIndex.modal);
            }
        },
        onAfterEnter() {
            this.focus();
