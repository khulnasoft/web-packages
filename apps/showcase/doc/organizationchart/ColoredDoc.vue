    ...
    data() {
        return {
            data: {
                ...
                data: {
                    image: 'https://khulnasoft.com/cdn/khulnasoft/images/avatar/amyelsner.png',
                    name: 'Amy Elsner',
                    title: 'CEO'
                },
                children: [
                    {
                        ...
                        data: {
                            image: 'https://khulnasoft.com/cdn/khulnasoft/images/avatar/annafali.png',
                            name: 'Anna Fali',
                            title: 'CMO'
                        },
                        children: [
                    ...
                    },
                    {
                        ...
                        data: {
                            image: 'https://khulnasoft.com/cdn/khulnasoft/images/avatar/stephenshaw.png',
                            name: 'Stephen Shaw',
                            title: 'CTO'
                        },
                        children: [
