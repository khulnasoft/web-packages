...
<script>
import { getAttribute, getFirstFocusableElement, getNextElementSibling, getOuterWidth, getPreviousElementSibling, invokeElementMethod } from '@khulnasoft/utils/dom';
import { resolveFieldData } from '@khulnasoft/utils/object';
import BaseComponent from '@khulnasoft/core/basecomponent';
import { getVNodeProp } from '@khulnasoft/core/utils';
import BarsIcon from '@khulnasoft/icons/bars';
...
import PencilIcon from '@khulnasoft/icons/pencil';
...
export default {
    ...
    computed: {
        ...
        expandButtonAriaLabel() {
            return this.$khulnasoft.config.locale.aria ? (this.isRowExpanded ? this.$khulnasoft.config.locale.aria.expandRow : this.$khulnasoft.config.locale.aria.collapseRow) : undefined;
        },
        initButtonAriaLabel() {
            return this.$khulnasoft.config.locale.aria ? this.$khulnasoft.config.locale.aria.editRow : undefined;
        },
        saveButtonAriaLabel() {
            return this.$khulnasoft.config.locale.aria ? this.$khulnasoft.config.locale.aria.saveEdit : undefined;
        },
        cancelButtonAriaLabel() {
            return this.$khulnasoft.config.locale.aria ? this.$khulnasoft.config.locale.aria.cancelEdit : undefined;
        }
    },
    components: {
