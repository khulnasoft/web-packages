<template>
    ...
    <div class="card flex justify-center">
        <Rating v-model="value">
            <template #onicon>
                <img src="https://khulnasoft.com/cdn/khulnasoft/images/rating/custom-onicon.png" height="24" width="24" />
            </template>
            <template #officon>
                <img src="https://khulnasoft.com/cdn/khulnasoft/images/rating/custom-officon.png" height="24" width="24" />
            </template>
        </Rating>
    </div>
