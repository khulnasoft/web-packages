...
<script>
import { focus, getFirstFocusableElement } from '@khulnasoft/utils/dom';
import { UniqueComponentId } from '@khulnasoft/core/utils';
import BanIcon from '@khulnasoft/icons/ban';
import StarIcon from '@khulnasoft/icons/star';
import StarFillIcon from '@khulnasoft/icons/starfill';
...
export default {
    ...
    methods: {
        ...
        starAriaLabel(value) {
            return value === 1 ? this.$khulnasoft.config.locale.aria.star : this.$khulnasoft.config.locale.aria.stars.replace(/{star}/g, value);
        }
    },
    components: {
        StarFillIcon,
