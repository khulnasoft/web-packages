...
<script>
import { absolutePosition, addStyle, findSingle, focus, getFirstFocusableElement, getFocusableElements, getLastFocusableElement, getOuterWidth, isTouchDevice, relativePosition } from '@khulnasoft/utils/dom';
import { equals, findLastIndex, isEmpty, isNotEmpty, isPrintableCharacter, resolveFieldData } from '@khulnasoft/utils/object';
import { ZIndex } from '@khulnasoft/utils/zindex';
import { FilterService } from '@khulnasoft/core/api';
...
import SearchIcon from '@khulnasoft/icons/search';
import SpinnerIcon from '@khulnasoft/icons/spinner';
import TimesIcon from '@khulnasoft/icons/times';
import Checkbox from 'khulnasoft/checkbox';
import Chip from 'khulnasoft/chip';
import IconField from 'khulnasoft/iconfield';
import InputIcon from 'khulnasoft/inputicon';
...
import VirtualScroller from 'khulnasoft/virtualscroller';
...
export default {
    ...
    methods: {
        ...
        onOverlayEnter(el) {
            ZIndex.set('overlay', el, this.$khulnasoft.config.zIndex.overlay);
        ...
        getSelectedItemsLabel() {
            let pattern = /{(.*?)}/;
            const selectedItemsLabel = this.selectedItemsLabel || this.$khulnasoft.config.locale.selectionMessage;
    ...
    computed: {
        ...
        filterMessageText() {
            return this.filterMessage || this.$khulnasoft.config.locale.searchMessage || '';
        },
        emptyFilterMessageText() {
            return this.emptyFilterMessage || this.$khulnasoft.config.locale.emptySearchMessage || this.$khulnasoft.config.locale.emptyFilterMessage || '';
        },
        emptyMessageText() {
            return this.emptyMessage || this.$khulnasoft.config.locale.emptyMessage || '';
        },
        selectionMessageText() {
            return this.selectionMessage || this.$khulnasoft.config.locale.selectionMessage || '';
        },
        emptySelectionMessageText() {
            return this.emptySelectionMessage || this.$khulnasoft.config.locale.emptySelectionMessage || '';
        },
        selectedMessageText() {
        ...
        toggleAllAriaLabel() {
            return this.$khulnasoft.config.locale.aria ? this.$khulnasoft.config.locale.aria[this.allSelected ? 'selectAll' : 'unselectAll'] : undefined;
        },
        listAriaLabel() {
            return this.$khulnasoft.config.locale.aria ? this.$khulnasoft.config.locale.aria.listLabel : undefined;
        },
