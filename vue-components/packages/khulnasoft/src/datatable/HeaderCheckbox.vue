...
export default {
    ...
    computed: {
        headerCheckboxAriaLabel() {
            return this.$khulnasoft.config.locale.aria ? (this.checked ? this.$khulnasoft.config.locale.aria.selectAll : this.$khulnasoft.config.locale.aria.unselectAll) : undefined;
        }
    },
    components: {
        CheckIcon,
