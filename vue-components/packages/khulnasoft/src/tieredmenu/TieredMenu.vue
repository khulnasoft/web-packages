...
<script>
import { absolutePosition, addStyle, findSingle, focus, getOuterWidth, isTouchDevice } from '@khulnasoft/utils/dom';
import { findLastIndex, isEmpty, isNotEmpty, isPrintableCharacter, resolve } from '@khulnasoft/utils/object';
...
export default {
    ...
    methods: {
        ...
        onEnter(el) {
            if (this.autoZIndex) {
                ZIndex.set('menu', el, this.baseZIndex + this.$khulnasoft.config.zIndex.menu);
            }
