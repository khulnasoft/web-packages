...
<script>
import { find, scrollInView, setAttribute } from '@khulnasoft/utils/dom';
import { findIndexInList, isEmpty } from '@khulnasoft/utils/object';
import { UniqueComponentId } from '@khulnasoft/core/utils';
import AngleDoubleDownIcon from '@khulnasoft/icons/angledoubledown';
import AngleDoubleLeftIcon from '@khulnasoft/icons/angledoubleleft';
import AngleDoubleRightIcon from '@khulnasoft/icons/angledoubleright';
import AngleDoubleUpIcon from '@khulnasoft/icons/angledoubleup';
import AngleDownIcon from '@khulnasoft/icons/angledown';
import AngleLeftIcon from '@khulnasoft/icons/angleleft';
import AngleRightIcon from '@khulnasoft/icons/angleright';
import AngleUpIcon from '@khulnasoft/icons/angleup';
import Button from 'khulnasoft/button';
import Listbox from 'khulnasoft/listbox';
    ...
    methods: {
        ...
        createStyle() {
            if (!this.styleElement && !this.isUnstyled) {
                ...
                setAttribute(this.styleElement, 'nonce', this.$khulnasoft?.config?.csp?.nonce);
...
`;
    ...
    computed: {
        ...
        moveUpAriaLabel() {
            return this.$khulnasoft.config.locale.aria ? this.$khulnasoft.config.locale.aria.moveUp : undefined;
        },
        moveTopAriaLabel() {
            return this.$khulnasoft.config.locale.aria ? this.$khulnasoft.config.locale.aria.moveTop : undefined;
        },
        moveDownAriaLabel() {
            return this.$khulnasoft.config.locale.aria ? this.$khulnasoft.config.locale.aria.moveDown : undefined;
        },
        moveBottomAriaLabel() {
            return this.$khulnasoft.config.locale.aria ? this.$khulnasoft.config.locale.aria.moveBottom : undefined;
        },
        moveToTargetAriaLabel() {
            return this.$khulnasoft.config.locale.aria ? this.$khulnasoft.config.locale.aria.moveToTarget : undefined;
        },
        moveAllToTargetAriaLabel() {
            return this.$khulnasoft.config.locale.aria ? this.$khulnasoft.config.locale.aria.moveAllToTarget : undefined;
        },
        moveToSourceAriaLabel() {
            return this.$khulnasoft.config.locale.aria ? this.$khulnasoft.config.locale.aria.moveToSource : undefined;
        },
        moveAllToSourceAriaLabel() {
            return this.$khulnasoft.config.locale.aria ? this.$khulnasoft.config.locale.aria.moveAllToSource : undefined;
        }
    },
    components: {
        Listbox,
