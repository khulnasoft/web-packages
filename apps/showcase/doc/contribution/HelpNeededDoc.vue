<template>
    <DocSectionText v-bind="$attrs">
        ...
        <p>
            Assist other users by participating in the issue tracker, <a href="https://github.com/orgs/khulnasoft/discussions/categories/khulnasoft" target="_blank" rel="noopener noreferrer">GitHub discussions</a>, and the
