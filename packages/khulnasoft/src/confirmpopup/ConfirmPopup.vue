...
<script>
import { $dt } from '@khulnasoft/styled';
import { absolutePosition, addClass, focus, getOffset, isTouchDevice } from '@khulnasoft/utils/dom';
import { ZIndex } from '@khulnasoft/utils/zindex';
import { ConnectedOverlayScrollHandler } from '@khulnasoft/core/utils';
    ...
    computed: {
        ...
        acceptLabel() {
            if (this.confirmation) {
                ...
                return confirmation.acceptLabel || confirmation.acceptProps?.label || this.$khulnasoft.config.locale.accept;
            }

            return this.$khulnasoft.config.locale.accept;
        },
        rejectLabel() {
            if (this.confirmation) {
                const confirmation = this.confirmation;

                return confirmation.rejectLabel || confirmation.rejectProps?.label || this.$khulnasoft.config.locale.reject;
            }

            return this.$khulnasoft.config.locale.reject;
        },
        acceptIcon() {
