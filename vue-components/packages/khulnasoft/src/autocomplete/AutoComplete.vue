...
<script>
import { absolutePosition, addStyle, findSingle, focus, getOuterWidth, isTouchDevice, relativePosition } from '@khulnasoft/utils/dom';
import { equals, findLastIndex, isEmpty, isNotEmpty, resolveFieldData } from '@khulnasoft/utils/object';
...
export default {
    ...
    computed: {
        ...
        searchMessageText() {
            return this.searchMessage || this.$khulnasoft.config.locale.searchMessage || '';
        },
        emptySearchMessageText() {
            return this.emptySearchMessage || this.$khulnasoft.config.locale.emptySearchMessage || '';
        },
