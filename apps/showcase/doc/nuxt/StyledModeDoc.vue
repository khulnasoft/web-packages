<template>
    <DocSectionText v-bind="$attrs">
        ...
        <p>Install the <i>@khulnasoft/themes</i> add-on package as the themes are not included in PrimeVue by default.</p>
    ...
    data() {
        return {
            code1: {
                basic: `
# Using npm
npm install @khulnasoft/themes

# Using yarn
yarn add @khulnasoft/themes

# Using pnpm
pnpm add @khulnasoft/themes
`
            },
            code2: {
                basic: `
