<template>
    <DocSectionText v-bind="$attrs">
        <p>
            Tailwind CSS in particular is a popular choice, we have even built the <a href="https://tailwind.khulnasoft.com">Tailwind CSS presets</a> spin-off project for the unstyled mode to be able to use the utility classes to style the PrimeVue
