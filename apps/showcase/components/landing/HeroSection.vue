    ...
    <section class="landing-hero py-20 px-8 lg:px-20">
        <div class="flex flex-col items-center">
            ...
            <div class="flex items-center gap-4">
                ...
                <a href="https://github.com/khulnasoft/web-packages" target="_blank" rel="noopener noreferrer" class="linkbox">
            ...
            <div :class="isSlimMenu ? 'w-auto' : 'w-72'" class="rounded-2xl p-5 bg-surface-50 dark:bg-surface-900 h-full flex flex-col justify-between">
                ...
                <div :class="isSlimMenu ? 'w-12 flex flex-col items-center' : 'w-auto'">
                    ...
                    <div :class="isSlimMenu ? 'justify-center' : ' gap-3'" class="flex items-center">
                        <Avatar image="https://www.khulnasoft.com/cdn/khulnasoft/images/landing/apps/main-avatar.png" size="large" shape="circle" class="shrink-0" />
                        <div>
                    ...
                    <div class="flex flex-col h-screen overflow-auto">
                        <div class="">
                            <div class="flex align-items-center gap-3 p-6">
                                <Avatar image="https://www.khulnasoft.com/cdn/khulnasoft/images/landing/apps/avatar11.jpg" size="large" class="rounded-xl overflow-hidden" />
                                <div class="flex-1">
...
export default {
    data() {
        return {
            ...
            sampleOptions: [
                { icon: 'pi pi-home', title: 'Overview', src: 'https://www.khulnasoft.com/cdn/khulnasoft/images/landing/apps/sampleshots/overview' },
                { icon: 'pi pi-comment', title: 'Chat', src: 'https://www.khulnasoft.com/cdn/khulnasoft/images/landing/apps/sampleshots/chat' },
                { icon: 'pi pi-inbox', title: 'Inbox', src: 'https://www.khulnasoft.com/cdn/khulnasoft/images/landing/apps/sampleshots/mail' },
                { icon: 'pi pi-th-large', title: 'Cards', src: 'https://www.khulnasoft.com/cdn/khulnasoft/images/landing/apps/sampleshots/cards' },
                { icon: 'pi pi-user', title: 'Customers', src: 'https://www.khulnasoft.com/cdn/khulnasoft/images/landing/apps/sampleshots/customers' },
                { icon: 'pi pi-video', title: 'Movies', src: 'https://www.khulnasoft.com/cdn/khulnasoft/images/landing/apps/sampleshots/movies' }
            ],
            selectedSampleOption: { icon: 'pi pi-home', title: 'Overview', src: 'https://www.khulnasoft.com/cdn/khulnasoft/images/landing/apps/sampleshots/overview' },
            visibleRight: false,
            selectedSidebarOption: 'Statistics',
            sidebarOptions: ['Interaction Logs', 'Preferences', 'Statistics', 'Opportunities'],
            callLogs: [
                { image: 'https://www.khulnasoft.com/cdn/khulnasoft/images/landing/apps/avatar6.png', name: 'Brook Simmons', time: '02.02.2024 | 45 min' },
                { image: 'https://www.khulnasoft.com/cdn/khulnasoft/images/landing/apps/avatar12.jpg', name: 'Jacob Jones', time: '02.02.2024 | 45 min' },
                { image: 'https://www.khulnasoft.com/cdn/khulnasoft/images/landing/apps/avatar13.jpg', name: 'Annette Black', time: '02.03.2024 | 13 min' },
                { image: 'https://www.khulnasoft.com/cdn/khulnasoft/images/landing/apps/avatar9.jpg', name: 'Arlene McCoy', time: '02.03.2024 | 14 min' },
                { image: 'https://www.khulnasoft.com/cdn/khulnasoft/images/landing/apps/avatar10.jpg', name: 'Arlene Simmons', time: '02.03.2024 | 14 min' },
                { image: 'https://www.khulnasoft.com/cdn/khulnasoft/images/landing/apps/avatar11.jpg', name: 'Michael Brown', time: '02.04.2024 | 20 min' }
            ],
            emailRecords: [
                {
                    image: 'https://www.khulnasoft.com/cdn/khulnasoft/images/landing/apps/avatar2.png',
                    name: 'Brook Simmons',
                    time: '3:24 PM',
                ...
                {
                    image: 'https://www.khulnasoft.com/cdn/khulnasoft/images/landing/apps/avatar7.png',
                    name: 'Jacob Jones',
                    time: '12.23.2023',
                ...
                {
                    image: 'https://www.khulnasoft.com/cdn/khulnasoft/images/landing/apps/avatar8.png',
                    name: 'Annette Black',
                    time: '12.17.2023',
                ...
                {
                    image: 'https://www.khulnasoft.com/cdn/khulnasoft/images/landing/apps/avatar11.jpg',
                    name: 'Arlene McCoy',
                    time: '06.17.2023',
                ...
                {
                    image: 'https://www.khulnasoft.com/cdn/khulnasoft/images/landing/apps/avatar13.jpg',
                    name: 'Arlene Simmons',
                    time: '04.17.2023',
            ...
            opportunities: [
                {
                    title: 'Apollo',
                    link: 'https://khulnasoft.com/templates/apollo/',
                    image: 'https://khulnasoft.com/cdn/khulnasoft/images/layouts/apollo-vue.jpg',
                    text: 'Keep your application fresh with Apollo, the newest and most modern template available.'
                },
                {
                    title: 'Ultima',
                    link: 'https://khulnasoft.com/templates/ultima/',
                    image: 'https://khulnasoft.com/cdn/khulnasoft/images/layouts/ultima-vue.jpg',
                    text: "Elevate your application's intuitiveness with Ultima's premium Material Design interface."
                },
                {
                    title: 'Diamond',
                    link: 'https://khulnasoft.com/templates/diamond/',
                    image: 'https://khulnasoft.com/cdn/khulnasoft/images/layouts/diamond-remastered-vue.jpg',
                    text: "Handle complex operations with elegance with Diamond's robust and powerful premium design."
                },
                {
                    title: 'Atlantis',
                    link: 'https://khulnasoft.com/templates/atlantis/',
                    image: 'https://khulnasoft.com/cdn/khulnasoft/images/layouts/atlantis-vue.jpg',
                    text: "Boost your application's capabilities, customization with the Atlantis template."
                },
                {
                    title: 'Verona',
                    link: 'https://khulnasoft.com/templates/verona/',
                    image: 'https://khulnasoft.com/cdn/khulnasoft/images/layouts/verona-vue.jpg',
                    text: "Achieve sophistication and subtlety with Verona's minimalistic, content-focused design."
                },
                {
                    title: 'Freya',
                    link: 'https://khulnasoft.com/templates/freya/',
                    image: 'https://khulnasoft.com/cdn/khulnasoft/images/layouts/freya-vue.png',
