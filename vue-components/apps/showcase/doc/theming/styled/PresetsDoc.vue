<template>
    <DocSectionText v-bind="$attrs">
        <p>
            ...
            <a href="https://github.com/khulnasoft/web-packages/tree/master/packages/themes/src/presets" target="_blank" rel="noopener noreferrer">source code</a> to learn more about the structure of presets. You may use them out of the box with
