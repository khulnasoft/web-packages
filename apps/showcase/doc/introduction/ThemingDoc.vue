<template>
    <DocSectionText v-bind="$attrs">
        <p class="mb-0">
            ...
            Bulma or your own custom CSS. We've even further built the <a href="tailwind.khulnasoft.com" target="_blank" rel="noopener noreferrer">Tailwind Presets</a> library to skin the UI library with utility classes of Tailwind. This design is
