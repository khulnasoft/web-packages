    ...
    <div class="flex-1 h-full overflow-y-auto overflow-x-clip overflow-hidden flex border border-surface rounded-2xl">
        ...
        <div class="w-8/12 xl:w-6/12 border-x border-surface flex flex-col">
            <div class="flex items-center p-4 gap-7 border-b border-surface">
                <div class="flex items-center">
                    <Avatar image="https://www.khulnasoft.com/cdn/khulnasoft/images/landing/apps/avatar-primetek.png" class="mr-2 av" size="large" shape="circle" />
                    <div class="flex-1">
        ...
        <div class="w-3/12 xl:block hidden min-w-40 py-6 px-3 overflow-auto">
            <div class="flex flex-col items-center justify-center">
                <Avatar image="https://www.khulnasoft.com/cdn/khulnasoft/images/landing/apps/avatar-primetek.png" class="w-32 h-32" size="xlarge" shape="circle" />
    ...
    data() {
        return {
            ...
            chats: [
                ...
                {
                    image: 'https://www.khulnasoft.com/cdn/khulnasoft/images/landing/apps/avatar-primetek.png',
                    name: 'PrimeTek Team',
                    capName: 'PT',
                    active: undefined,
                ...
                {
                    image: 'https://www.khulnasoft.com/cdn/khulnasoft/images/landing/apps/avatar12.jpg',
                    name: 'Robert Fox',
                    capName: 'RF',
                    active: false,
                    unreadMessageCount: 0,
                ...
                {
                    image: 'https://www.khulnasoft.com/cdn/khulnasoft/images/landing/apps/avatar9.jpg',
                ...
                {
                    image: 'https://www.khulnasoft.com/cdn/khulnasoft/images/landing/apps/avatar6.png',
                    name: 'Ralph Edwards',
                    capName: 'RE',
                    active: false,
                    unreadMessageCount: 0,
            ...
            chatMessages: [
                ...
                { id: 2, attachment: '', name: '', image: 'https://www.khulnasoft.com/cdn/khulnasoft/images/landing/apps/avatar8.png', capName: 'A', type: 'received', message: 'PrimeVue rocks! Simplifies UI dev with versatile components.' },
                { id: 3, attachment: '', name: '', image: 'https://www.khulnasoft.com/cdn/khulnasoft/images/landing/apps/avatar11.jpg', capName: 'A', type: 'received', message: 'Intriguing! Tell us more about its impact.' },
                {
                    id: 4,
                    attachment: 'https://www.khulnasoft.com/cdn/khulnasoft/images/landing/apps/message-image.png',
                    name: '',
                    image: 'https://www.khulnasoft.com/cdn/khulnasoft/images/landing/apps/avatar2.png',
                    capName: 'A',
                    type: 'received',
                ...
                { id: 5, attachment: '', name: '', image: 'https://www.khulnasoft.com/cdn/khulnasoft/images/landing/apps/avatar5.png', capName: 'A', type: 'sent', message: 'Customizable themes, responsive design – UI excellence!' },
                { id: 6, attachment: '', name: '', image: 'https://www.khulnasoft.com/cdn/khulnasoft/images/landing/apps/avatar8.png', capName: 'A', type: 'received', message: 'Love it! Fast-tracking our development is key.' },
                { id: 7, attachment: '', name: '', image: 'https://www.khulnasoft.com/cdn/khulnasoft/images/landing/apps/avatar6.png', capName: 'A', type: 'received', message: 'Documentation rocks too – smooth integration for all.' },
                {
                    id: 8,
                    attachment: '',
                    name: '',
                    image: 'https://www.khulnasoft.com/cdn/khulnasoft/images/landing/apps/avatar5.png',
                    capName: 'B',
                    type: 'sent',
            ...
            chatMedia: [
                'https://www.khulnasoft.com/cdn/khulnasoft/images/landing/apps/chat-image1.png',
                'https://www.khulnasoft.com/cdn/khulnasoft/images/landing/apps/chat-image2.png',
                'https://www.khulnasoft.com/cdn/khulnasoft/images/landing/apps/chat-image3.png',
                'https://www.khulnasoft.com/cdn/khulnasoft/images/landing/apps/chat-image4.png',
                'https://www.khulnasoft.com/cdn/khulnasoft/images/landing/apps/chat-image5.png'
            ],
            members: [
                { name: 'Robin Jonas', capName: 'RJ', image: 'https://www.khulnasoft.com/cdn/khulnasoft/images/landing/apps/avatar2.png' },
                { name: 'Cameron Williamson', capName: 'CW', image: 'https://www.khulnasoft.com/cdn/khulnasoft/images/landing/apps/avatar11.jpg' },
                { name: 'Eleanor Pena', capName: 'EP', image: 'https://www.khulnasoft.com/cdn/khulnasoft/images/landing/apps/avatar5.png' },
                { name: 'Arlene McCoy', capName: 'AM', image: 'https://www.khulnasoft.com/cdn/khulnasoft/images/landing/apps/avatar8.png' },
