        ...
        <DataTable :value="products" :rows="5" paginator tableStyle="min-width: 50rem">
            ...
            <Column header="Image" class="w-1/6">
                <template #body="slotProps">
                    <img :src="`https://khulnasoft.com/cdn/khulnasoft/images/product/${slotProps.data.image}`" :alt="slotProps.data.image" class="w-16 shadow-sm" />
                </template>
            </Column>
            ...
            <div v-if="selectedProduct" class="rounded flex flex-col">
                <div class="flex justify-center rounded">
                    <div class="relative mx-auto">
                        <img class="rounded w-44 sm:w-64" :src="`https://khulnasoft.com/cdn/khulnasoft/images/product/${selectedProduct.image}`" :alt="selectedProduct.name" />
