...
export default {
    ...
    computed: {
        checkboxAriaLabel() {
            return this.$khulnasoft.config.locale.aria ? (this.checked ? this.$khulnasoft.config.locale.aria.selectRow : this.$khulnasoft.config.locale.aria.unselectRow) : undefined;
        }
    },
    components: {
        CheckIcon,
