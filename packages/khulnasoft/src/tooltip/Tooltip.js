import { addClass, createElement, fadeIn, findSingle, getAttribute, getOuterHeight, getOuterWidth, getViewport, getWindowScrollLeft, getWindowScrollTop, hasClass, isExist, isTouchDevice, removeClass } from '@khulnasoft/utils/dom';
import { isEmpty } from '@khulnasoft/utils/object';
...
const Tooltip = BaseTooltip.extend('tooltip', {
    beforeMount(el, options) {
        ...
        target.$_ptooltipZIndex = options.instance.$khulnasoft?.config?.zIndex?.tooltip;
