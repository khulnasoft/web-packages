    ...
    <div :ref="containerRef" class="layout-topbar">
        <div class="layout-topbar-inner">
            ...
            <ul class="topbar-items">
                ...
                <li>
                    <a href="https://github.com/khulnasoft/web-packages" target="_blank" rel="noopener noreferrer" class="topbar-item">
                ...
                <li>
                    <a href="https://github.com/orgs/khulnasoft/discussions" target="_blank" rel="noopener noreferrer" class="topbar-item">
    ...
    data() {
        return {
            versions: [
                ...
                {
                    name: 'v3',
                    url: 'https://v3.khulnasoft.com'
                },
                {
                    name: 'v2',
                    url: 'https://www.khulnasoft.com/khulnasoft-v2'
                }
            ]
        };
    },
