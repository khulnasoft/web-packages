import { Theme, dt } from '@khulnasoft/styled';
import { isNotEmpty, minifyCSS, resolve } from '@khulnasoft/utils/object';
import { useStyle } from '@khulnasoft/core/usestyle';
...
export default {
    ...
    getStyleSheet(extendedCSS = '', props = {}) {
        if (this.css) {
            ...
            return isNotEmpty(_style) ? `<style type="text/css" data-khulnasoft-style-id="${this.name}" ${_props}>${_style}</style>` : '';
        }
    ...
    getThemeStyleSheet(params, props = {}) {
        ...
        if (this.theme) {
            ...
            isNotEmpty(_style) && css.push(`<style type="text/css" data-khulnasoft-style-id="${name}" ${_props}>${_style}</style>`);
        }
