...
const INLINE_EXTERNALS = [/@khulnasoft\/core\/.*/];
const EXTERNALS = [...GLOBAL_EXTERNALS, ...INLINE_EXTERNALS];

// alias
const ALIAS_ENTRIES = [
    {
        find: /^@khulnasoft\/icons\/(.*)$/,
    ...
    { find: '@khulnasoft/icons/baseicon/style', replacement: path.resolve(__dirname, './src/baseicon/style/BaseIconStyle.js') },
    { find: '@khulnasoft/icons/baseicon', replacement: path.resolve(__dirname, './src/baseicon/BaseIcon.vue') }
];
